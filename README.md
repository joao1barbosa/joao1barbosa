...
Backend & platform-focused Software Engineer. I work on a high-throughput **payments gateway**
(fintech) and run an advanced **homelab** as my R&D lab, where I prove techniques before they
reach production.
...
<table>
  ...
  <tr>
    <td valign="middle"><b>Infra / Platform</b></td>
    <td valign="middle">
...
- Platform engineering toward an **LLMOps** horizon
- Refactoring legacy systems · building financial gateway integrations
- **Studying:** Golang, FilamentPHP, InertiaJS
